...
const DEFAULT: OAuthConfig = { enabled: false, login_enabled: false, login_microsoft: false, login_github: false, mode: 'register', configured: false, microsoft_configured: false, github_configured: false }
